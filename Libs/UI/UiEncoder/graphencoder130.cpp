#include "graphencoder130.h"
#include "ui_graphencoder130.h"
...
class GraphEncoder130Private:public IGraphEncoderPrivate
{
  Q_DECLARE_PUBLIC(GraphEncoder130)
public:
  GraphEncoder130Private(){}
  ~GraphEncoder130Private(){}
protected:

};

GraphEncoder130::GraphEncoder130(QWidget *parent) :
  IGraphEncoder(*(new GraphEncoder130Private),parent),
  ui(new Ui::GraphEncoder130)
{
  ui->setupUi(this);
...
GraphEncoder130::~GraphEncoder130()
{
  Q_D(GraphEncoder130);
  GT::deletePtrObject(d->m_encConfigManage);
  delete ui;
}
void GraphEncoder130::setCustomVisitActive(IUiWidget *uiWidget)
{
  Q_D(GraphEncoder130);
  d->m_iDataBinding=new EncConfigBinding130(this);
  qDebug()<<"d->m_iDataBinding=new EncConfigBinding130(this)";
...
void GraphEncoder130::setUiVersionName()
{
  Q_D(GraphEncoder130);
  d->m_versionName="V130";
}

void GraphEncoder130::setupDataMappings()
{

}
void GraphEncoder130::syncTreeDataToUiFace()
{
  Q_D(GraphEncoder130);
...
void GraphEncoder130::onUpdateTimeOut()
{
  Q_D(GraphEncoder130);
  quint32 pos;
  quint32 posIn;
...
//!
//! \brief GraphEncoder130::onBtnEncConfigClicked 打开编码器设置对话框
//! \param checked
//!
void GraphEncoder130::onBtnEncConfigClicked(bool checked)
{
...
void GraphEncoder130::onRadioBtnClicked()
{
...
void GraphEncoder130::onBtnSearchPhaseClicked()
{
  Q_D(GraphEncoder130);
...
void GraphEncoder130::onBtnSavePhaseClicked()
{
  Q_D(GraphEncoder130);
...
void GraphEncoder130::onEncConfigListWidgetRowChanged(int curRow)
{
  Q_D(GraphEncoder130);
...
void GraphEncoder130::readGearPrm()
{
  Q_D(GraphEncoder130);
  qint32 a = 1;
  qint32 b = 1;
...
void GraphEncoder130::onEncActive()
{
  qDebug()<<"onEncActive";
  initCurEncConfigItem();
...
void GraphEncoder130::onBtnClearEcnAlarmClicked()
{
  Q_D(GraphEncoder130);
...
void GraphEncoder130::onCheckBoxGearAssociationClicked(bool checked)
{
  setGearAssociateUiEnable(!checked);
}

void GraphEncoder130::onBtnEncConfigSaveClicked()
{
  Q_D(GraphEncoder130);
...
void GraphEncoder130::initDial(QwtDial *dial)
{
...
void GraphEncoder130::setEncConfigUiEnable(bool en)
{
...
void GraphEncoder130::setEncErrorUiEnable(bool en)
{
  ui->listWidget_encErr->setVisible(en);
  ui->btn_encClearErr->setVisible(en);
}
void GraphEncoder130::updateEncConfigUiByCurrentConfigItem()
{
  Q_D(GraphEncoder130);
  if(d->m_curEncConfigItem!=NULL)
  {
...
void GraphEncoder130::showEncoderError(quint16 lost,quint16 encinfo)
{
  Q_D(GraphEncoder130);
  if(d->m_curEncConfigItem!=NULL)
  {
...
void GraphEncoder130::initCurEncConfigItem()
{
  Q_D(GraphEncoder130);
...
void GraphEncoder130::setGearAssociateUiEnable(bool en)
{
...
quint32 GraphEncoder130::gdc(qint32 a, qint32 b)
{
  quint32 ret ;
  if(a > b)
    ret = b;
