#include "graphencoder126.h"
#include "ui_graphencoder126.h"
...
class GraphEncoder126Private:public IGraphEncoderPrivate
{
  Q_DECLARE_PUBLIC(GraphEncoder126)
public:
  GraphEncoder126Private(){}
  ~GraphEncoder126Private(){}
protected:

};

GraphEncoder126::GraphEncoder126(QWidget *parent) :
  IGraphEncoder(*(new GraphEncoder126Private),parent),
  ui(new Ui::GraphEncoder126)
{
  ui->setupUi(this);
...
GraphEncoder126::~GraphEncoder126()
{
  Q_D(GraphEncoder126);
  GT::deletePtrObject(d->m_encConfigManage);
  delete ui;
}
void GraphEncoder126::setCustomVisitActive(IUiWidget *uiWidget)
{
  Q_D(GraphEncoder126);
  d->m_iDataBinding=new EncConfigBinding126(this);
  qDebug()<<"d->m_iDataBinding=new EncConfigBinding126(this)";
...
void GraphEncoder126::setUiVersionName()
{
  Q_D(GraphEncoder126);
  d->m_versionName="V126";
}

void GraphEncoder126::setupDataMappings()
{

}
void GraphEncoder126::syncTreeDataToUiFace()
{
  Q_D(GraphEncoder126);
...
void GraphEncoder126::createSupportEncoderItem()
{
  ...
  warnList<<tr("Over Speed")
         <<tr("Full absolute status")
        <<tr("Counting Error")
       <<tr("Counter Overflow")
      <<tr("0")
     <<tr("Multi-turn Error")
...
void GraphEncoder126::onUpdateTimeOut()
{
  Q_D(GraphEncoder126);
  quint32 pos;
  quint32 posIn;
...
//!
//! \brief GraphEncoder126::onBtnEncConfigClicked 打开编码器设置对话框
//! \param checked
//!
void GraphEncoder126::onBtnEncConfigClicked(bool checked)
{
...
void GraphEncoder126::onRadioBtnClicked()
{
...
void GraphEncoder126::onBtnSearchPhaseClicked()
{
  Q_D(GraphEncoder126);
...
void GraphEncoder126::onBtnSavePhaseClicked()
{
  Q_D(GraphEncoder126);
...
void GraphEncoder126::onEncConfigListWidgetRowChanged(int curRow)
{
  Q_D(GraphEncoder126);
...
void GraphEncoder126::onEncActive()
{
  qDebug()<<"onEncActive";
  initCurEncConfigItem();
}
void GraphEncoder126::onBtnClearEcnAlarmClicked()
{
  Q_D(GraphEncoder126);
...
void GraphEncoder126::onBtnEncConfigSaveClicked()
{
  Q_D(GraphEncoder126);
...
void GraphEncoder126::initDial(QwtDial *dial)
{
...
void GraphEncoder126::setEncConfigUiEnable(bool en)
{
...
void GraphEncoder126::setEncErrorUiEnable(bool en)
{
  ui->listWidget_encErr->setVisible(en);
  ui->btn_encClearErr->setVisible(en);
}
void GraphEncoder126::updateEncConfigUiByCurrentConfigItem()
{
  Q_D(GraphEncoder126);
  if(d->m_curEncConfigItem!=NULL)
  {
...
void GraphEncoder126::showEncoderError(quint16 lost,quint16 encinfo)
{
  Q_D(GraphEncoder126);
  if(d->m_curEncConfigItem!=NULL)
  {
...
void GraphEncoder126::initCurEncConfigItem()
{
  Q_D(GraphEncoder126);
