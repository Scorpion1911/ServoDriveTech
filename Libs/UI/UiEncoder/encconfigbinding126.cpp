...
EncConfigBinding126::EncConfigBinding126(QObject *parent) : IDataBinding(parent)
{

}
EncConfigBinding126::~EncConfigBinding126()
{

}
void EncConfigBinding126::syncMultiUiDataToTree()
{
...
void EncConfigBinding126::syncMultiTreeToUiData()
{
  IEncConfigItem *encItem=dynamic_cast<IEncConfigItem *>(m_dataMultiObj);
  double gain,value;
  QTreeWidgetItem *item;
...
void EncConfigBinding126::syncUiDataToTreeItem()
{

}

//!
//! \brief EncConfigBinding126::syncTreeItemToUiData 为了获得当前编码器配置是哪一种
//!
void EncConfigBinding126::syncTreeItemToUiData()
{
  qDebug()<<"TEST_OUT 1";
  ...
  index&=0x000f;//V126版本中0-3bit代表编码器类型 12-15是波特率
