#include "homeitem30.h"
#include "sevdevice.h"
#include "bititemhelper.h"

#include <QMessageBox>

HomeItem30::HomeItem30(int axisInx, SevDevice *dev, QObject *parent) : IHomeConfigItem(axisInx, dev, parent)
{
    m_homeType = 30;
    setObjectName(tr("30 Homing on negative side falling edge of home switch (home switch at middle of travel); initial move negative"));
}

HomeItem30::~HomeItem30()
{

}

bool HomeItem30::execute()
{
    quint16 trigSrc = 0;
    quint16 trigMode = 0;
    int negativeIO = 0;
