#include "homeitem25.h"
#include "sevdevice.h"
#include "bititemhelper.h"

#include <QMessageBox>

HomeItem25::HomeItem25(int axisInx, SevDevice *dev, QObject *parent) : IHomeConfigItem(axisInx, dev, parent)
{
    m_homeType = 25;
    setObjectName(tr("25 Homing on positive side rising edge of home switch (home switch at middle of travel); initial move positive"));
}

HomeItem25::~HomeItem25()
{

}

bool HomeItem25::execute()
{
    quint16 trigSrc = 0;
    quint16 trigMode = 0;
    int negativeIO = 0;
