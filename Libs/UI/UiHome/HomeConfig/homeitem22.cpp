#include "homeitem22.h"
#include "sevdevice.h"
#include "bititemhelper.h"

#include <QMessageBox>

HomeItem22::HomeItem22(int axisInx, SevDevice *dev, QObject *parent) : IHomeConfigItem(axisInx, dev, parent)
{
    m_homeType = 22;
    setObjectName(tr("22 Homing on rising edge of home switch (home switch at negative travel)"));
}

HomeItem22::~HomeItem22()
{

}

bool HomeItem22::execute()
{
    quint16 trigSrc = 0;
    quint16 trigMode = 0;
    int negativeIO = 0;
