#include "homeitem27.h"
#include "sevdevice.h"
#include "bititemhelper.h"

#include <QMessageBox>

HomeItem27::HomeItem27(int axisInx, SevDevice *dev, QObject *parent) : IHomeConfigItem(axisInx, dev, parent)
{
    m_homeType = 27;
    setObjectName(tr("27 Homing on positive side falling edge of home switch (home switch at middle of travel); initial move negative"));
}

HomeItem27::~HomeItem27()
{

}

bool HomeItem27::execute()
{
    quint16 trigSrc = 0;
    quint16 trigMode = 0;
    int negativeIO = 0;
