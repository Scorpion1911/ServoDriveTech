#include "homeitem21.h"
#include "sevdevice.h"
#include "bititemhelper.h"

#include <QMessageBox>

HomeItem21::HomeItem21(int axisInx, SevDevice *dev, QObject *parent) : IHomeConfigItem(axisInx, dev, parent)
{
    m_homeType = 21;
    setObjectName(tr("21 Homing on falling edge of home switch (home switch at negative travel)"));
}

HomeItem21::~HomeItem21()
{

}

bool HomeItem21::execute()
{
    quint16 trigSrc = 0;
    quint16 trigMode = 0;
    int negativeIO = 0;
