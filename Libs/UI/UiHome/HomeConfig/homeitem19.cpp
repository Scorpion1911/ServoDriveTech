#include "homeitem19.h"
#include "sevdevice.h"
#include "bititemhelper.h"

#include <QMessageBox>

HomeItem19::HomeItem19(int axisInx, SevDevice *dev, QObject *parent) : IHomeConfigItem(axisInx, dev, parent)
{
    m_homeType = 19;
    setObjectName(tr("19 Homing on falling edge of home switch (home switch at positive travel)"));
}

HomeItem19::~HomeItem19()
{

}

bool HomeItem19::execute()
{
    quint16 trigSrc = 0;
    quint16 trigMode = 0;
    int negativeIO = 0;
